...
class _WelcomeScreenState extends State<WelcomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Gradient backgroundGradient = _backgroundChanged
                      ...
                      return Expanded(
                        child: GestureDetector(
                          ...
                          child: ScaleTransition(
                            scale: _animating ? _scaleAnimation : const AlwaysStoppedAnimation(1.0),
                            child: FeatureIcon(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: BigOptionCard(
                                ...
                                title: 'Consumidor',
                                subtitle: 'Encontre os melhores produtos locais',
                                color: theme.colorScheme.surface,
                                isProducer: false,
                              ),
                            ),
